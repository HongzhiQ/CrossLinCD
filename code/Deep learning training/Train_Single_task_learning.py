...
class XLMRobertaForMultiLabelSequenceClassification(nn.Module):
    def __init__(self, config, num_labels=15, drop=0.2):
...
train_texts, train_labels, train_mask = read_tsv('trainData_here', LABEL_COLUMNS)
val_texts, val_labels, val_mask = read_tsv('testData_here', LABEL_COLUMNS)
